...
export default function DetailBlogPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-teal-500/30">

      {/* Simple Navigation Bar */}
      <nav className="relative top-[70px] z-10">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center">
          <Link to="/blog" className='cursor-pointer'> <button className="flex items-center gap-2 text-slate-600 hover:text-slate-900 transition-colors group">
      ...
      {mainloder ? <>
        ...
        <header className="mb-10">
          ...
          {/* Meta Information */}
          <div className="flex flex-wrap items-center gap-6 text-slate-600 text-sm md:text-base mb-10 border-b border-slate-200/50 pb-8">
        ...
        {/* Featured Image */}
        <div className="relative w-full aspect-video md:aspect-21/9 rounded-2xl md:rounded-3xl overflow-hidden mb-12 shadow-2xl border border-slate-200/50 bg-[#0d1526]">
          <img
        ...
        {/* Article Body */}
        <article className="prose prose-invert prose-lg max-w-none prose-p:text-slate-700 prose-p:leading-relaxed prose-headings:text-slate-900 prose-a:text-teal-400 hover:prose-a:text-teal-300 prose-img:rounded-xl">
      ...
      {/* Simple Footer */}
      <footer className="border-t border-slate-200/50 mt-20 bg-[#0d1526]/50">
        <div className="max-w-4xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-600 text-sm">© 2026 Tech Insights Blog. All rights reserved.</p>
